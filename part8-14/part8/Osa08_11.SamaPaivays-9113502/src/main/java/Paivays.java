...
public class Paivays {
    ...
    public boolean equals(Object object) {
        // jos sama kuin verrattava = true
        if (this == object) {
            return true;
        }
        
        // Onko olio Paivays-luokkaan kuuluva? jos ei nii false
        if (!(object instanceof Paivays)) {
            return false;
        }
        
        // Muutetaan samaksi olioluokaksi
        Paivays verrattava = (Paivays) object;
        if (this.paiva == verrattava.paiva && this.kuukausi == verrattava.kuukausi && this.vuosi == verrattava.vuosi ) {
            return true;
        }
